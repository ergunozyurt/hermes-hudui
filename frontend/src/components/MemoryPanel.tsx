...
export default function MemoryPanel({ selectedProfile }: { selectedProfile: string }) {
  ...
  return (
    <>
      <Panel title={`Agent Memory · ${profileLabel(data?.profile || selectedProfile)}`} className="col-span-1">
      ...
      <Panel title={`User Profile · ${profileLabel(data?.profile || selectedProfile)}`} className="col-span-1">
